<template>
    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" xmlns:xlink="http://www.w3.org/1999/xlink"
        xmlns:svgjs="http://svgjs.com/svgjs" width="50" height="100" x="0" y="0" viewBox="0 0 512.056 512.056"
        style="enable-background:new 0 0 512 512" xml:space="preserve" class="">
        <circle r="256.028" cx="256.028" cy="256.028" fill="#bac8d3" shape="circle"></circle>
        <g transform="matrix(0.7,0,0,0.7,76.80830841064454,76.80840911865235)">
            <g>
                <g>
                    <g>
				...
				C511.899,245.194,476.655,200.443,426.635,188.224z" fill="#1f85af" data-original="#000000" class=""></path>
                        <path d="M245.035,253.664l-64,64l22.56,22.56l36.8-36.64v153.44h32v-153.44l36.64,36.64l22.56-22.56l-64-64
				C261.354,247.46,251.276,247.46,245.035,253.664z" fill="#1f85af" data-original="#000000" class=""></path>
                    </g>
                </g>
            </g>
            <g>
